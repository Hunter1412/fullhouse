(function ($) {
    ...
    var MERCADO_JS = {
        ...
        //actions - increase/reduce quantity in cart and checkout
...
var btnOpen = document.querySelector(".remember-forgot a");
...
btnOpen.addEventListener("click", Model);
btnClose.addEventListener("click", Model);
